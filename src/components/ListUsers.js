...
export default class ListUsers extends React.Component {
  ...
  fetchData = async () => {
    axios.get('https://rolodex2.azurewebsites.net/api/v1/SubCategories/' + this.state.subCategoryId +'/Listings?code=DQzhL1VTa16VEZkR3EOCB2MdgtmllfFgMcW/PVjzMQVv89n7ksR1Iw==')
        .then((response) => {
