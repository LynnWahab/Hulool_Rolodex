...
export default class SubCategoriesPage extends React.Component {
  ...
  fetchData = async () => {
    axios.get('https://rolodex2.azurewebsites.net/api/v1/Categories/'+ this.state.clicked.toString() + '/SubCategories?code=DQzhL1VTa16VEZkR3EOCB2MdgtmllfFgMcW/PVjzMQVv89n7ksR1Iw==')
        .then((response) => {
